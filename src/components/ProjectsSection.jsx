  ...
  const projects = [
    {
      ...
      image: import.meta.env.BASE_URL + "assets/mourafi9i.png",
      technologies: ["Flutter", "Dart", "Firebase"],
      category: "mobile",
      github:
        "https://www.canva.com/design/DAGeLS7m-t0/DYHOnFJxO4ZhtW_KS-BCpg/view?mode=prototype",
    ...
    },
    {
      ...
      description:
        "Création de sites web portfolio numériques interactifs, conçus pour offrir une expérience utilisateur immersive, avec un design moderne et responsive, une navigation fluide, des animations dynamiques et une présentation soignée des compétences.",
      image: import.meta.env.BASE_URL + "assets/website.png",
    ...
    },
    {
      ...
      description:
        "Tari9i est une application de covoiturage simplifiée pour les trajets collectifs. Réservation rapide, interface intuitive et trajets optimisés pour faciliter la mobilité quotidienne.",
      image: import.meta.env.BASE_URL + "assets/tari9i.png",
    ...
    },
    {
      ...
      description:
        "Tari9iPro est une application dédiée aux chauffeurs, leur permettant de gérer les trajets, réservations, paiements et historique de conduite.",
      image: import.meta.env.BASE_URL + "assets/tari9ipro.png",
      technologies: ["Flutter", "Firebase", "Dart", "MAPs"],
      category: "mobile",
    ...
    },
    {
      ...
      description:
        "PTU permet aux étudiants de suivre leurs cours, consulter leurs notes, emploi du temps et carte d’étudiant, tandis que les enseignants peuvent publier du contenu en ligne.",
      image: import.meta.env.BASE_URL + "assets/PTU.png",
    ...
    },
    {
      ...
      description:
        "Création de vidéos courtes et engageantes pour les plateformes sociales (Instagram, TikTok, YouTube Shorts).",
      image: import.meta.env.BASE_URL + "assets/makeit.jpg",
    ...
    },
    {
      ...
      description:
        "Création de visuels impactants et harmonieux pour les réseaux sociaux : Instagram, Facebook, LinkedIn, etc.",
      image: import.meta.env.BASE_URL + "assets/SocialMedia.jpg",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className="project-card bg-white rounded-lg overflow-hidden shadow-lg"
            >
